...
package creeper.mrspeedy35.creeperautogg.gui;

import creeper.mrspeedy35.creeperautogg.CreeperAutoGG;
import creeper.mrspeedy35.creeperautogg.gui.modern.ModernGui;
import creeper.mrspeedy35.creeperautogg.gui.modern.ModernButton;
import creeper.mrspeedy35.creeperautogg.gui.modern.ModernTextBox;
...
public class SettingsGui extends ModernGui {
    ...
    private static final CreeperAutoGG modInstance = CreeperAutoGG.getInstance();
    ...
    public void drawScreen(int x, int y, float ticks) {
        ...
        drawTitle("CreeperAutoGG v" + CreeperAutoGG.VERSION);
    ...
    public void buttonPressed(ModernButton button) {
        switch (button.getId()) {
            case 1:
                ...
                this.changed = true;
                button.setText("CreeperAutoGG: " + getStatus(modInstance.isOn()));
