...
public abstract class ModernGui extends GuiScreen {
    ...
    public final void sendChatMessage(String msg) {
        Minecraft.getMinecraft().thePlayer.addChatComponentMessage(new ChatComponentText(ChatColor.GREEN + "CreeperAutoGG" + ChatColor.GOLD + " > " + ChatColor.GRAY + ChatColor.translateAlternateColorCodes(msg)));
    }
