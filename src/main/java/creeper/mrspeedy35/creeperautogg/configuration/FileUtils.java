...
package creeper.mrspeedy35.creeperautogg.configuration;
...
public class FileUtils {
    ...
    public void loadConfig() {
        if (configExists()) {
            ...
            CreeperAutoGG.getInstance().setOn(this.config.has("enabled") && this.config.get("enabled").getAsBoolean());
            CreeperAutoGG.getInstance().setTickDelay(this.config.has("delay") ? this.config.get("delay").getAsInt() : 20);
        } else {
    ...
    public void saveConfig() {
        ...
        try {
            ...
            config.addProperty("enabled", CreeperAutoGG.getInstance().isOn());
            config.addProperty("delay", CreeperAutoGG.getInstance().getTickDelay());
